    ...
    calculateRent() {
        ...
        try {
            ...
            document.getElementById('result').innerHTML = `
                ...
                <div class="rent-amount">$${Math.round(predictedRent).toLocaleString()}</div>
            `;
            ...
            randomSample.forEach(record => {
                tableHTML += `
                    <tr>
                        ...
                        <td>$${record.rent_amount.toLocaleString()}</td>
                    </tr>
                `;
            });
                ...
                metricsHTML = `
                    ...
                    <div class="metrics">
                        <div class="metric">
                            ...
                            <span class="metric-value">$${Math.round(this.metrics.mae).toLocaleString()}</span>
                        </div>
                        <div class="metric">
                            <span class="metric-label">Mean Squared Error:</span>
                            <span class="metric-value">${Math.round(this.metrics.mse).toLocaleString()}</span>
                        </div>
                        <div class="metric">
                            <span class="metric-label">Root Mean Squared Error:</span>
                            <span class="metric-value">$${Math.round(this.metrics.rmse).toLocaleString()}</span>
                        </div>
                        <div class="metric">
                            <span class="metric-label">R-squared (R²):</span>
                            <span class="metric-value">${this.metrics.r2.toFixed(4)}</span>
                        </div>
                    </div>
                `;
            } else {
