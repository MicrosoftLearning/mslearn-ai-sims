...
lab:
  ...
  description: Explore applications that demonstrates how AI natural language processing
    capabilities can be used to transcribe and analyze spoken and written text.
  duration: 15 minutes
  level: 100
  islab: true
---
